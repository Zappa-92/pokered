...
const_value = 0
	...
	const HS_CINNABAR_GYM_BLAINE	       ; C1 BLAINE DISSAPEARS FROM GYM
	const HS_CINNABAR_LAB_BLAINE           ; C2 BLAINE APPEARS IN LAB
	...
	const HS_CERULEAN_CAVE_B1F_MEWTWO      ; $D1 = CERULEAN_CAVE_B1F, $01
	const HS_CERULEAN_CAVE_B1F_GIOVANNI    ; $D2 = CERULEAN_CAVE_B1F, $04
	const HS_CERULEAN_CAVE_B1F_ITEM_2      ; REMUEVO HS_CERULEAN_CAVE_B1F_ITEM_2 porque ya existia linea 59
	const HS_VIRIDIAN_GYM_RIVAL            ; $D4 = VIRIDIAN_GYM, $02
