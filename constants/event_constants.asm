const_value = 0
	...
	const EVENT_GOT_ROCK_TUNNEL_FOSSIL		         ; FOSIL NUEVO
	const EVENT_BEAT_OAK                             ; PELEA OAK
	...
	const EVENT_GAVE_HIGGS_TO_BLAINE                 ; 139, (D76E, bit 1)
	...
	const EVENT_9E0			                         ; ELIMINAR FLAUTA DOBLE
