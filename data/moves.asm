...
MoveEnd:
	...
	move RAZOR_WIND,   CHARGE_EFFECT,               56, FLYING,    75, 10
	...
	move SLAM,         NO_ADDITIONAL_EFFECT,        56, NORMAL,    75, 20
	move VINE_WHIP,    NO_ADDITIONAL_EFFECT,        25, GRASS,    100, 10
	move STOMP,        FLINCH_SIDE_EFFECT2,         45, NORMAL,   100, 20
	...
	move THRASH,       THRASH_PETAL_DANCE_EFFECT,   63, NORMAL,   100, 20
	...
	move SUBMISSION,   RECOIL_EFFECT,               56, FIGHTING,  80, 25
	...
	move SHADOW_THIEF, SPECIAL_DOWN_SIDE_EFFECT,    56, GHOST,    100, 15
	move SLAYER,       DEFENSE_DOWN_SIDE_EFFECT,    42, DRAGON,   100, 25
