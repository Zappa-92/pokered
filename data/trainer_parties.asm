...
BeautyData:
; Celadon Gym
	db 33,GLOOM,WEEPINBELL,TANGELA,IVYSAUR,0
...
; Victory Road 2F
	db 51,MACHOP,MACHOKE,MACHAMP,0
Green1Data:
	db 5,SQUIRTLE,0
	db 5,BULBASAUR,0
	db 5,CHARMANDER,0
...
; Rocket Hideout B1F
	...
	db 37,RATICATE,EKANS,0
	db 35,GRIMER,KOFFING,PONYTA,0
	db 35,RATICATE,KADABRA,GRIMER,SPEAROW,0
	db 38,SHELLDER,KOFFING,0
; Rocket Hideout B2F
	db 40,DITTO,KOFFING,GRIMER,PORYGON,RATICATE,0
; Rocket Hideout B3F
	db 39,CHARMELEON,RATICATE,DROWZEE,0
	db 41,MACHOP,GEODUDE,0
; Rocket Hideout B4F
	db 40,SANDSLASH,EKANS,DRAGONAIR,0
	db 40,ARBOK,SANDSHREW,SNORLAX,0
	db 41,MUK,FLAREON,0
; Pokémon Tower 7F
...
; Silph Co. 9F
	db 41,KRABBY,GRIMER,SHELLDER,0
	db 40,HAUNTER,MUK,HYPNO,0
; Silph Co. 10F
	db 44,SCYTHER,0
; Silph Co. 11F
...
BlaineData:
	db $FF,51,RAPIDASH,52,ARCANINE,54,CHARIZARD,56,MAGMAR,0
SabrinaData:
