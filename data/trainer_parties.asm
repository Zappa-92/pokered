...
; Route 3
	...
	db 19,JIGGLYPUFF,0
; Route 4
	db 43,DITTO,NIDORINA,PARASECT,0
; Mt. Moon 1F
...
; Route 16
	...
	db 44,WEEZING,0
	db 40,GRIMER,PARAS,DIGLETT,RHYDON,0
; Route 17
...
; Celadon Gym
	...
	db 35,EXEGGCUTE,0
; Route 13
	db 42,JYNX,PIKACHU,SANDSLASH,0
...
; Rematch
	db $FF,76,SANDSLASH,78,NIDOKING,77,MAROWAK,78,RHYDON,79,DUGTRIO,80,PERSIAN,0
RocketData:
; Mt. Moon B2F
...
; Silph Co. 2F
	...
	db 40,GOLBAT,PARAS,STARMIE,RATICATE,MEOWTH,0
; Silph Co. 3F
...
; Silph Co. 9F
	db 44,KRABBY,GRIMER,CLOYSTER,0
...
; Victory Road 3F
	...
	db 54,NIDOQUEEN,DEWGONG,CHANSEY,0
; Unused
...
SabrinaData:
	db $FF,52,HYPNO,53,MR_MIME,52,SLOWBRO,54,ALAKAZAM,0
...
; Viridian Gym Rematch (new team 4)
    db $FF,77,TAUROS,75,SCYTHER,78,MACHAMP,78,ARCANINE,81,JOLTEON,80,BLASTOISE,0
    db $FF,77,TAUROS,75,SCYTHER,78,MACHAMP,78,GYARADOS,81,FLAREON,80,VENUSAUR,0
    db $FF,77,TAUROS,75,SCYTHER,78,MACHAMP,78,EXEGGUTOR,81,VAPOREON,80,CHARIZARD,0
LoreleiData:
