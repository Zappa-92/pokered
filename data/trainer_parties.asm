...
; Route 13
	db 41,PIDGEOTTO,MEOWTH,RATTATA,PIKACHU,WIGGLYTUFF,0
	db 43,POLIWHIRL,SEEL,0
	db 40,PIDGEOTTO,MEOWTH,DUGTRIO,PIDGEOTTO,0
...
; Route 15
	db 41,GLOOM,ODDISH,ODDISH,0
	db 40,PIKACHU,RAICHU,0
	db 44,CLEFAIRY,0
	db 40,BELLSPROUT,ODDISH,TANGELA,0
; Route 20
...
; Route 21
	...
	db 42,MAGIKARP,MAGIKARP,MAGIKARP,MAGIKARP,MAGIKARP,GYARADOS,0
...
; Mansion 3F
	db 47,RAICHU,MAGNETON,VOLTORB,0
; Mansion B1F
