...
; Route 22
	db $FF,56,PIDGEOT,54,DITTO,54,ARCANINE,55,JOLTEON,58,ALAKAZAM,60,BLASTOISE,0
	db $FF,56,PIDGEOT,54,DITTO,54,GYARADOS,55,FLAREON,58,ALAKAZAM,60,VENUSAUR,0
	db $FF,56,PIDGEOT,54,DITTO,54,EXEGGUTOR,55,VAPOREON,58,ALAKAZAM,60,CHARIZARD,0
Green3Data:
