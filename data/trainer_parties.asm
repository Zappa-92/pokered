...
Green1Data:
	...
	db 5,CHARMANDER,0
; Route 22
	db $FF,12,PIDGEY,10,SQUIRTLE,0
	db $FF,12,PIDGEY,10,BULBASAUR,0
	db $FF,12,PIDGEY,10,CHARMANDER,0
; Cerulean City
...
; Silph Co. 7F
	...
	db $FF,46,PIDGEOT,44,GYARADOS,46,FLAREON,45,ALAKAZAM,47,VENUSAUR,0
	db $FF,46,PIDGEOT,44,EXEGGCUTE,46,VAPOREON,45,ALAKAZAM,47,CHARIZARD,0
; Route 22
	db $FF,56,PIDGEOT,54,RHYDON,54,GROWLITHE,55,JOLTEON,58,ALAKAZAM,60,BLASTOISE,0
	db $FF,56,PIDGEOT,54,RHYDON,54,GYARADOS,55,FLAREON,58,ALAKAZAM,60,VENUSAUR,0
	db $FF,56,PIDGEOT,54,RHYDON,54,EXEGGCUTE,55,VAPOREON,58,ALAKAZAM,60,CHARIZARD,0
Green3Data:
