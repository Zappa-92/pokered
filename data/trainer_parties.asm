...
; Viridian Gym Rematch (new team 4)
    	db $FF,72,ALAKAZAM,70,PIDGEOT,74,TAUROS,74,ARCANINE,77,JOLTEON,75,BLASTOISE,0
    	db $FF,72,ALAKAZAM,70,PIDGEOT,74,TAUROS,74,GYARADOS,77,FLAREON,75,VENUSAUR,0
    	db $FF,72,ALAKAZAM,70,PIDGEOT,74,TAUROS,74,EXEGGUTOR,77,VAPOREON,75,CHARIZARD,0
LoreleiData:
